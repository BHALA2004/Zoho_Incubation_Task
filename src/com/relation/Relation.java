...
public class Relation {
    public static void main(String[] args) {
        ...
        list.add(new Member("bala's dad's dad",null,null,'M'));    // 0
        list.add(new Member("bala's dad's mom",null,null,'F'));   // 1
        list.add(new Member("Kannan",list.get(0),list.get(1),'F'));     // 2

        list.add(new Member("bala's mom's dad",null,null,'M'));//3
        list.add(new Member("bala's mom's dad",null,null,'F'));//4
        list.add(new Member("Thangam",list.get(3),list.get(4),'F'));//5
        list.add(new Member("Bala",list.get(2),list.get(5),'M'));//6
        list.add(new Member("xxx",null,null,'F'));//7
        list.add(new Member("yyy",list.get(6),list.get(7),'M'));//8
        list.add(new Member("zzz",list.get(6),list.get(7),'M'));//9
        list.add(new Member("vvv",list.get(6),list.get(7),'F'));//10
        list.add(new Member("bala's mom's sibling 1",list.get(3),list.get(4),'F'));//11
        list.add(new Member("bala's mom's sibling 2",list.get(3),list.get(4),'F'));//12
        list.add(new Member("bala's mom's sibling 3",list.get(3),list.get(4),'M'));//13
